function getSections(text) {
    let sections = [];
    const sectionsRegex = /^(LEY|LEYES|DECRETOS|DECRETOS SINTETIZADOS|RESOLUCIONES|FALLOS|DISPOSICIONES|DISPOSICIÓN|LICITACIONES|CONCURSO DE PRECIOS|CONCURSOS|COMUNICADOS|CONTRATACI[OÓ]N DIRECTA|EXPURGO DOCUMENTAL|EDICTOS LEY PIERRI|EDICTOS NOTIFICATORIOS|REGISTRO REDAM|EDICTOS DE MINERÍA|EDICTOS DE MENSURA|EDICTO DPA|EDICTOS D\.P\.A\.|EDICTO D\.P\.A\.|EDICTOS I\.P\.P\.V\.|EDICTO I\.P\.P\.V\.|NÓMINA PREADJUDICATARIOS DE VIVIENDA)\n((?:.+\n?)+?)(?=^(?:LEY|LEYES|DECRETOS|DECRETOS SINTETIZADOS|RESOLUCIONES|FALLOS|DISPOSICIONES|DISPOSICIÓN|LICITACIONES|CONCURSO DE PRECIOS|CONCURSOS|COMUNICADOS|CONTRATACI[OÓ]N DIRECTA|EXPURGO DOCUMENTAL|EDICTOS LEY PIERRI|EDICTOS NOTIFICATORIOS|REGISTRO REDAM|EDICTOS DE MINERÍA|EDICTOS DE MENSURA|EDICTO DPA|EDICTOS D\.P\.A\.|EDICTO D\.P\.A\.|EDICTOS I\.P\.P\.V\.|EDICTO I\.P\.P\.V\.|NÓMINA PREADJUDICATARIOS DE VIVIENDA)\n|$)/gm;
    let match;
